...
public class ResourceManager
{
	...
	public Dictionary<string, GameObject> _gameObject = new Dictionary<string, GameObject>();
	public T Load<T>(string path) where T : Object
	{
		...
		{
			if (_gameObject.TryGetValue(path, out GameObject sprite))
				return sprite as T;

			GameObject sp = Resources.Load<GameObject>(path);
			_gameObject.Add(path, sp);
			return sp as T;
		}
